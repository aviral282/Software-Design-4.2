...
class MyFrameQ7 extends JFrame implements ActionListener {
	...
	private JButton b2 = new JButton("None > Target");
	private JTextField t3 = new JTextField("0", 15);
	private JPanel p1 = new JPanel();
	ArrayList<Integer> list = new ArrayList<Integer>();

	public static boolean noneGreater(ArrayList list, int tar) { // to be completed
		if (list.size() == 0)
			return true;
		else {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (target == b2) {
			...
			boolean res = noneGreater(new ArrayList(list), tar);
			t3.setText("" + res);
		}
	}
}
